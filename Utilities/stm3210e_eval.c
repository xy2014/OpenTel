...
GPIO_TypeDef* GPIO_PORT_ADC[ADC_CHANNEL_SUM] = {ADC_CHANNEL1_GPIO_PORT, ADC_CHANNEL2_GPIO_PORT, ADC_CHANNEL3_GPIO_PORT, ADC_CHANNEL4_GPIO_PORT,
                                                ADC_CHANNEL5_GPIO_PORT, ADC_CHANNEL6_GPIO_PORT, ADC_CHANNEL7_GPIO_PORT, ADC_CHANNEL8_GPIO_PORT};
const uint16_t GPIO_PIN_ADC[ADC_CHANNEL_SUM] = {ADC_CHANNEL1_PIN, ADC_CHANNEL2_PIN, ADC_CHANNEL3_PIN, ADC_CHANNEL4_PIN,
                                                ADC_CHANNEL5_PIN, ADC_CHANNEL6_PIN, ADC_CHANNEL7_PIN, ADC_CHANNEL8_PIN};
const uint32_t GPIO_CLK_ADC[ADC_CHANNEL_SUM] = {ADC_CHANNEL1_GPIO_CLK, ADC_CHANNEL2_GPIO_CLK, ADC_CHANNEL3_GPIO_CLK, ADC_CHANNEL4_GPIO_CLK,
                                                ADC_CHANNEL5_GPIO_CLK, ADC_CHANNEL6_GPIO_CLK, ADC_CHANNEL7_GPIO_CLK, ADC_CHANNEL8_GPIO_CLK};
...
void STM_EVAL_ADC_Port_Init(ADCChannel_TypeDef ADCChannel)
{
  ...
  /* Enable the GPIO_LED Clock */
  RCC_APB2PeriphClockCmd(GPIO_CLK_ADC[ADCChannel], ENABLE);

  /* Configure the GPIO_LED pin */
  GPIO_InitStructure.GPIO_Pin = GPIO_PIN_ADC[ADCChannel];
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AIN;
  GPIO_Init(GPIO_PORT_ADC[ADCChannel], &GPIO_InitStructure);
}
...
void Bk242x_LowLevel_Init(void) 
{
  ...
  /*!<Bk242x_SPI_CE_GPIO, Bk242x_SPI_CS_GPIO, Bk242x_SPI_MOSI_GPIO, Bk242x_SPI_MISO_GPIO 
       and Bk242x_SPI_SCK_GPIO Periph clock enable */
  RCC_APB2PeriphClockCmd(Bk242x_CE_GPIO_CLK | Bk242x_CS_GPIO_CLK | Bk242x_SPI_MOSI_GPIO_CLK | Bk242x_SPI_MISO_GPIO_CLK |
                         Bk242x_SPI_SCK_GPIO_CLK, ENABLE);

  /*!< Bk242x_SPI Periph clock enable */
  RCC_APB2PeriphClockCmd(Bk242x_SPI_CLK, ENABLE);
  
  /*!< Configure Bk242x_SPI pins: SCK */
  GPIO_InitStructure.GPIO_Pin = Bk242x_SPI_SCK_PIN;
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;
  GPIO_Init(Bk242x_SPI_SCK_GPIO_PORT, &GPIO_InitStructure);

  /*!< Configure Bk242x_SPI pins: MOSI */
  GPIO_InitStructure.GPIO_Pin = Bk242x_SPI_MOSI_PIN;
  GPIO_Init(Bk242x_SPI_MOSI_GPIO_PORT, &GPIO_InitStructure);

  /*!< Configure Bk242x_SPI pins: MISO */
  GPIO_InitStructure.GPIO_Pin = Bk242x_SPI_MISO_PIN;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;  
  GPIO_Init(Bk242x_SPI_MISO_GPIO_PORT, &GPIO_InitStructure);
  
  /*!< Configure Bk242x_CS_PIN pin: Bk242x CS pin */
  GPIO_InitStructure.GPIO_Pin = Bk242x_CS_PIN;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
  GPIO_Init(Bk242x_CS_GPIO_PORT, &GPIO_InitStructure);
	
  /*!< Configure Bk242x_CE_PIN pin: Bk242x CE pin */
  GPIO_InitStructure.GPIO_Pin = Bk242x_CE_PIN;
  GPIO_Init(Bk242x_CE_GPIO_PORT, &GPIO_InitStructure);
}

void Bk242xTx_CS_LOW(void) {
	GPIO_ResetBits(Bk242x_CS_GPIO_PORT, Bk242x_CS_PIN);
}
void Bk242xTx_CS_HIGH(void){
	GPIO_SetBits(Bk242x_CS_GPIO_PORT, Bk242x_CS_PIN)   ;
}
void Bk242xTx_CE_LOW(void){
	GPIO_ResetBits(Bk242x_CE_GPIO_PORT, Bk242x_CE_PIN);
}
void Bk242xTx_CE_HIGH(void){
	GPIO_SetBits(Bk242x_CE_GPIO_PORT, Bk242x_CE_PIN);
}
