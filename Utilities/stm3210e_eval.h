...
/** @addtogroup STM3210E_EVAL_LOW_LEVEL_ADC
  * @{
  */
#define ADC_CHANNEL_SUM               8
	 
#define ADC_CHANNEL1_PIN              GPIO_Pin_6
#define ADC_CHANNEL1_GPIO_PORT        GPIOC
#define ADC_CHANNEL1_GPIO_CLK         RCC_APB2Periph_GPIOC 
#define ADC_CHANNEL1                  ADC_Channel_1	 
	 
#define ADC_CHANNEL2_PIN              GPIO_Pin_6
#define ADC_CHANNEL2_GPIO_PORT        GPIOC
#define ADC_CHANNEL2_GPIO_CLK         RCC_APB2Periph_GPIOC  
#define ADC_CHANNEL2                  ADC_Channel_2	
	 
#define ADC_CHANNEL3_PIN              GPIO_Pin_6
#define ADC_CHANNEL3_GPIO_PORT        GPIOC
#define ADC_CHANNEL3_GPIO_CLK         RCC_APB2Periph_GPIOC  
#define ADC_CHANNEL3                  ADC_Channel_3	 

#define ADC_CHANNEL4_PIN              GPIO_Pin_6
#define ADC_CHANNEL4_GPIO_PORT        GPIOC
#define ADC_CHANNEL4_GPIO_CLK         RCC_APB2Periph_GPIOC  
#define ADC_CHANNEL4                  ADC_Channel_4	 

#define ADC_CHANNEL5_PIN              GPIO_Pin_6
#define ADC_CHANNEL5_GPIO_PORT        GPIOC
#define ADC_CHANNEL5_GPIO_CLK         RCC_APB2Periph_GPIOC  
#define ADC_CHANNEL5                  ADC_Channel_5	 

#define ADC_CHANNEL6_PIN              GPIO_Pin_6
#define ADC_CHANNEL6_GPIO_PORT        GPIOC
#define ADC_CHANNEL6_GPIO_CLK         RCC_APB2Periph_GPIOC  
#define ADC_CHANNEL6                  ADC_Channel_6	 

#define ADC_CHANNEL7_PIN              GPIO_Pin_6
#define ADC_CHANNEL7_GPIO_PORT        GPIOC
#define ADC_CHANNEL7_GPIO_CLK         RCC_APB2Periph_GPIOC  
#define ADC_CHANNEL7                  ADC_Channel_7	 

#define ADC_CHANNEL8_PIN              GPIO_Pin_6
#define ADC_CHANNEL8_GPIO_PORT        GPIOC
#define ADC_CHANNEL8_GPIO_CLK         RCC_APB2Periph_GPIOC  
#define ADC_CHANNEL8                  ADC_Channel_8	 

#define STM_ADC_VALUE_MAX             (uint16_t)0x03ff                           //10λADC
#define STM_ADC_VALUE_MID             (uint16_t)0x01ff                           //10λADC
...
/** @addtogroup STM3210E_EVAL_LOW_LEVEL_BK242X_2.4G Transciver_SPI
  * @{
  */
/**
  * @brief  Bk242x 2.4G Transciver SPI Interface pins
  */  
#define Bk242x_SPI                       SPI1
#define Bk242x_SPI_CLK                   RCC_APB2Periph_SPI1
#define Bk242x_SPI_SCK_PIN               GPIO_Pin_5                  /* PA.05 */
#define Bk242x_SPI_SCK_GPIO_PORT         GPIOA                       /* GPIOA */
#define Bk242x_SPI_SCK_GPIO_CLK          RCC_APB2Periph_GPIOA
#define Bk242x_SPI_MISO_PIN              GPIO_Pin_6                  /* PA.06 */
#define Bk242x_SPI_MISO_GPIO_PORT        GPIOA                       /* GPIOA */
#define Bk242x_SPI_MISO_GPIO_CLK         RCC_APB2Periph_GPIOA
#define Bk242x_SPI_MOSI_PIN              GPIO_Pin_7                  /* PA.07 */
#define Bk242x_SPI_MOSI_GPIO_PORT        GPIOA                       /* GPIOA */
#define Bk242x_SPI_MOSI_GPIO_CLK         RCC_APB2Periph_GPIOA
#define Bk242x_CS_PIN                    GPIO_Pin_2                  /* PB.02 */
#define Bk242x_CS_GPIO_PORT              GPIOB                       /* GPIOB */
#define Bk242x_CS_GPIO_CLK               RCC_APB2Periph_GPIOB

#define Bk242x_CE_PIN                    GPIO_Pin_3                  /* PB.03 */
#define Bk242x_CE_GPIO_PORT              GPIOB                       /* GPIOB */
#define Bk242x_CE_GPIO_CLK               RCC_APB2Periph_GPIOB
/**
  * @}
  */
...
/**
  ...
  */
#define Bk242x_CS_LOW()       GPIO_ResetBits(Bk242x_CS_GPIO_PORT, Bk242x_CS_PIN)
/**
  * @brief  Deselect Bk242x: Chip Select pin high
  */
#define Bk242x_CS_HIGH()      GPIO_SetBits(Bk242x_CS_GPIO_PORT, Bk242x_CS_PIN)   

#define Bk242x_CE_LOW()       GPIO_ResetBits(Bk242x_CE_GPIO_PORT, Bk242x_CE_PIN)
/**
  * @brief  Deselect Bk242x:  ce pin high
  */
#define Bk242x_CE_HIGH()      GPIO_SetBits(Bk242x_CE_GPIO_PORT, Bk242x_CE_PIN)
...
void STM_EVAL_ADC_Port_Init(ADCChannel_TypeDef ADCChannel);
...
//++++++++++++++++++++++++++++++++++++++
void Bk242xTx_CS_LOW(void);
void Bk242xTx_CS_HIGH(void);
void Bk242xTx_CE_LOW(void);
void Bk242xTx_CE_HIGH(void);
void Bk242xRx_CS_LOW(void);
void Bk242xRx_CS_HIGH(void);
void Bk242xRx_CE_LOW(void);
void Bk242xRx_CE_HIGH(void);
//++++++++++++++++++++++++++++++++++++++
